<template>
  <div class="my-10 text-5xl font-semibold">Hongbusi</div>

  <p>Hi, I am Hongbusi, a front-end developer.</p>
...
p a {
  @apply border-b border-sky-500 hover:border-blue-400 hover:border-b-2;
}
</style>
